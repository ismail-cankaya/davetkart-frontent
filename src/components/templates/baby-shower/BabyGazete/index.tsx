...
const BABY_GAZETE_THEME: SectionTheme = {
  ...
  input: 'w-full bg-white border border-[#e6e2d6] rounded-lg px-3.5 py-2.5 text-sm text-[#53514a] placeholder:text-[#87857c] focus:outline-none focus:border-[#5f8f7f] focus:ring-2 focus:ring-[#5f8f7f]/18 transition duration-300',
