...
const KINA_GAZETE_THEME: SectionTheme = {
  ...
  input: 'w-full bg-white border border-[#e6d9c3] rounded-lg px-3.5 py-2.5 text-sm text-[#54473a] placeholder:text-[#877c6b] focus:outline-none focus:border-[#b8323f] focus:ring-2 focus:ring-[#b8323f]/18 transition duration-300',
