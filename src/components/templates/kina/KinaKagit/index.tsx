...
const KINA_KAGIT_THEME: SectionTheme = {
  ...
  input:
    'w-full bg-white/80 border border-[#e3ccce] rounded-lg px-3.5 py-2.5 text-sm text-[#5f4448] placeholder:text-[#b09296] focus:outline-none focus:border-[#9c2436] focus:ring-2 focus:ring-[#9c2436]/20 transition duration-300',
  buttonPrimary:
