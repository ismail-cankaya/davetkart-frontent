...
const DUGUN_GAZETE_THEME: SectionTheme = {
  ...
  input: 'w-full bg-white border border-[#e2dccb] rounded-lg px-3.5 py-2.5 text-sm text-[#4f4a3f] placeholder:text-[#847d6e] focus:outline-none focus:border-[#8c3f2f] focus:ring-2 focus:ring-[#8c3f2f]/18 transition duration-300',
