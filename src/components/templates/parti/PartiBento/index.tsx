...
const PARTI_BENTO_THEME: SectionTheme = {
  ...
  input:
    'w-full bg-white/[0.06] border border-white/12 rounded-lg px-3.5 py-2.5 text-sm text-[#f6f7f2] placeholder:text-[#8e9285] focus:outline-none focus:border-[#a3e635]/60 focus:ring-2 focus:ring-[#a3e635]/15 transition duration-300',
  buttonPrimary:
