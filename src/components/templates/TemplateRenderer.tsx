...
import {
  ...
  DogumGunuVitray, DogumGunuKinetik
} from './dogum-gunu';
import {
  ...
  MezuniyetVitray, MezuniyetKinetik
} from './mezuniyet';
import {
...
import {
  ...
  KurumsalVitray, KurumsalKinetik
} from './kurumsal';
