...
const KURUMSAL_POSTA_THEME: SectionTheme = {
  ...
  input: 'w-full bg-white border border-[#e0e4e6] rounded-lg px-3.5 py-2.5 text-sm text-[#4a4f53] placeholder:text-[#7e858a] focus:outline-none focus:border-[#2f6f8c] focus:ring-2 focus:ring-[#2f6f8c]/18 transition duration-300',
