...
const KURUMSAL_GAZETE_THEME: SectionTheme = {
  ...
  input: 'w-full bg-white border border-[#dfe3e6] rounded-lg px-3.5 py-2.5 text-sm text-[#484e52] placeholder:text-[#7c848a] focus:outline-none focus:border-[#1f5f7f] focus:ring-2 focus:ring-[#1f5f7f]/18 transition duration-300',
