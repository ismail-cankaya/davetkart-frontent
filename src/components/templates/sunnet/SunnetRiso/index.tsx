...
const SUNNET_RISO_THEME: SectionTheme = {
  ...
  input:
    'w-full bg-white/85 border border-[#181712]/15 rounded-lg px-3.5 py-2.5 text-sm text-[#35332c] placeholder:text-[#96948a] focus:outline-none focus:border-[#1c5fe0] focus:ring-2 focus:ring-[#1c5fe0]/20 transition duration-300',
  buttonPrimary:
