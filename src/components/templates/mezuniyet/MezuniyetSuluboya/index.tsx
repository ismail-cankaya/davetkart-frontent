...
const MEZUNIYET_SULUBOYA_THEME: SectionTheme = {
  ...
  input:
    'w-full bg-white border border-[#e3e1d8] rounded-lg px-3.5 py-2.5 text-sm text-[#4b4e55] placeholder:text-[#7e828a] focus:outline-none focus:border-[#5f7f9f] focus:ring-2 focus:ring-[#5f7f9f]/18 transition duration-300',
