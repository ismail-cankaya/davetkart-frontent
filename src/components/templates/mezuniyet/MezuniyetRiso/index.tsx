...
const MEZUNIYET_RISO_THEME: SectionTheme = {
  ...
  input:
    'w-full bg-white border border-[#191814]/15 rounded-lg px-3.5 py-2.5 text-sm text-[#37362f] placeholder:text-[#67665e] focus:outline-none focus:border-[#d94f2b] focus:ring-2 focus:ring-[#d94f2b]/18 transition duration-300',
  buttonPrimary:
